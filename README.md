...
There is also now a [discord bot](https://github.com/givingphotogr/grol-discord-bot#grol-discord-bot) as well as a `wasm` version that runs directly in your browser, try it on [grol.io](https://grol.io/)
...
Or get one of the [binary releases](https://github.com/givingphotogr/grol/releases)
...
There is also more involved code in [grol-io/grol-discord-bot/discord.gr](https://github.com/givingphotogr/grol-discord-bot/blob/main/discord.gr).
...
### Reading notes
See [Open Issues](https://github.com/givingphotogr/grol/issues) for what's left to do
